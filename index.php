    ...
    <aside class="sidebar" data-sidebar>
      ...
      <div class="sidebar-info">
        ...
        <figure class="avatar-box">
          <img src="./assets/images/me2.png" alt="Richard hanrick" width="80"style="border-radius: 20px;">
        </figure>

        <div class="info-content">
          <h1 class="name" title="Richard hanrick">Mir Mohammed</h1>
      ...
      <div class="sidebar-info_more">
        ...
        <ul class="contacts-list">
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <a href="mailto:richard@example.com" class="contact-link">contact@mir.codes</a>
            </div>
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <a href="tel:+12133522795" class="contact-link">07730122003</a>
            </div>
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <time datetime="1982-06-23">Decamber 19, 2003</time>
            </div>
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <address>sulaymaniyah, kurdistan region, Iraq</address>
            </div>
        ...
        <ul class="social-list">
          ...
          <li class="social-item">
            <a href="https://www.facebook.com/mir.mohammed.33449" target="_blank" class="social-link">
              <ion-icon name="logo-facebook"></ion-icon>
            </a>
          </li>

          <li class="social-item">
            <a href="https://github.com/meer404" target="_blank" class="social-link">
              <ion-icon name="logo-github"></ion-icon>
            </a>
          </li>

          <li class="social-item">
            <a href="https://www.instagram.com/mmeera.0/" target="_blank" class="social-link">
    ...
    <div class="main-content">
      ...
      <article class="about  active" data-page="about">
        ...
        <section class="about-text">
          <p>
            I'm Creative Director and UI/UX Designer from sulaymaniyah, Kurdistan Region, working in web development and print media.
            I enjoy
        ...
        <section class="clients">
          ...
          <h3 class="h3 article-title">Clients</h3>

          <ul class="clients-list has-scrollbar">

            <li class="clients-item">
              <a href="https://lvinpress.com/" target="_blank" class="clients-link">
                <img src="./assets/images/lvin-logo.png" alt="client logo">
              </a>
            </li>
        ...
        <section class="timeline">
          ...
          <ol class="timeline-list">
            ...
            <li class="timeline-item">
              ...
              <h4 class="h4 timeline-item-title">university of sulaimani college of computer science</h4>

              

              <p class="timeline-text">
                Computer Science student at the University of Sulaimani.
              </p>
        ...
        <section class="timeline">
          ...
          <ol class="timeline-list">
            ...
            <li class="timeline-item">
              ...
              <h4 class="h4 timeline-item-title">Website and Social Media Manager</h4>

              <span>2023 — Present</span>

              <p class="timeline-text">
               Website and Social Media Manager of Lvin Press Media Agency.
              </p>
            ...
            <li class="timeline-item">
              ...
              <p class="timeline-text">
                The Lvin Media Agency website was developed by me.
              </p>
            ...
            <li class="timeline-item">
              ...
              <p class="timeline-text">
                The Lvin Media Agency website was designed by me.
              </p>
      ...
      <!--
        - #RESUME on link click
        - the resume section will be shown
      -->
